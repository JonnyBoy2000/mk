...
class Statistics:
    ...
    async def retrieve_statistics(self, message):
...
def check_folder():
    if not os.path.exists("data/serverinfo"):
        print("Creating data/serverinfo folder...")
        os.makedirs("data/serverinfo")
...
def check_file():
    ...
    data['REFRESH_RATE'] = 5
    f = "data/serverinfo/settings.json"
